...
//      value[i] = (byte) 999999999;
//    }
    Map<String,byte[]> concurrentHashMap = new ConcurrentHashMap<String,byte[]>();
    concurrentHashMap.put("test", value);
    long start = System.currentTimeMillis();
    int[] iv = new int[8];
    String size = RamUsageEstimator.humanSizeOf("1");
    long eclapse = System.currentTimeMillis() - start;
    System.out.println("eclapse " + eclapse + " ms");
